...
public class ApiTest {
    ...
    public String WebClientApiTest(Model model , @RequestParam(required = false, name = "category") String category, @RequestParam(required = false, name = "keyword") String key) throws Exception{
        ...
        if(!keyword.isEmpty()) {
            book = wc.get()
                    .uri(uriBuilder -> uriBuilder.path("/v3/search/book")
                            ...
                            .queryParam("query", keyword).build())
